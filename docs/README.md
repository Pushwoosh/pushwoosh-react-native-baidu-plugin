...
# Pushwoosh React Native Baidu Module #

Provides module for React Native to receive and handle push notifications for Android using Baidu as a gateway to communicate with Chinese audience.
